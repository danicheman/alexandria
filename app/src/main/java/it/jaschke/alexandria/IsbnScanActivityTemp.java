 ...
 */
public class IsbnScanActivityTemp extends ActionBarActivity implements IsbnScanFragment.Callback {

    private String scannedIsbn = "-1";
    private static final String TAG = IsbnScanActivityTemp.class.getSimpleName();

    //empty constructor necessary to launch this activity.
    public IsbnScanActivityTemp() {
    }
